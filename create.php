            ...
            <div class="card-body">
                <form method="post" action="proses_create.php" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="custom-control custom-radio custom-control-inline">
                            <input type="radio" id="TKR" value="TKR" name="jurusan" class="custom-control-input">
                            <label class="custom-control-label" for="SIJA">TKR</label>
                        </div>
                        <div class="custom-control custom-radio custom-control-inline">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-check form-check-inline">
                            <input class="form-check-input" type="checkbox" name="hobi[]" id="inlineCheckbox1"
                                value="Taekwondo">
                            <label class="form-check-label" for="inlineCheckbox1">Taekwondo</label>
                        </div>
                        <div class="form-check form-check-inline">
